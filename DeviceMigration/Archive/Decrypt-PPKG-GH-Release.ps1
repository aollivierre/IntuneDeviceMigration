...
$repoOwner = "ollivierre"  # Replace with your GitHub username
$repoName = "Vault"    # Your private repo name
$releaseTag = "ICTC-PPKG-EJ-0.1"  # The tag for your release
$fileName = "ICTC_Project_2_Aug_29_2024.zip.aes.zip"  # Name of the uploaded ZIP in the release

# GitHub API URL to download the file from the release
...
# Get the download URL for the encrypted provisioning package ZIP
...
Invoke-WebRequest -Uri $fileUrl -OutFile $localEncryptedZipPath
